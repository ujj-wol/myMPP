...
public class Main {
	...
	public static boolean contains2(List<Employee> list, Employee e, 
		...
		for(Employee emp : list) {
			...
			else if(emp == null || e == null) return false;
			else if(pred2.test(emp, e)) return true;
		}
		return false;
	}
	...
	//new contains method is implemented that takes generic types
	public static void test2new() {
		List<Employee> list = new ArrayList<>();
		list.add(new Employee(1003, "Tom", 60000));
		list.add(new Employee(1002, "Harry", 70000));
		list.add(new Employee(1001, "Joe", 50000));
	...
	public static <T> boolean contains(List<? extends T> list, T e, 
		...
		for(T element : list) {
			if(element == null && e == null) return true;
			else if(element == null || e == null) return false;
			else if(pred2.test(element, e)) return true;
		}
		return false;
	}
